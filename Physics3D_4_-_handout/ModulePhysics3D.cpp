...
{
	btTypedConstraint* p2pConstraint = new btPoint2PointConstraint(*bodyA.body.GetBody(), *bodyB.body.GetBody(), pivotInA, pivotInB);
	world->addConstraint(p2pConstraint, false);
}
...
{
	btTypedConstraint* hingeConstraint = new btHingeConstraint(*bodyA.body.GetBody(), *bodyB.body.GetBody(), pivotInA, pivotInB,	axisInA, axisInB);
